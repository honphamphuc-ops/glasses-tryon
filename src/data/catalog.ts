...
export const glassesCatalog: GlassesModel[] = [
  {
    ...
    brand: 'RayStyle',
    modelPath: '/models/raw/glasses-001.glb',
  ...
  },
  {
    ...
    name: 'Urban Wayfarer',
    brand: 'RayStyle',
    modelPath: '/models/raw/glasses-002.glb',
  ...
  },
  {
    ...
    name: 'Retro Round',
    brand: 'VintageSpec',
    modelPath: '/models/raw/glasses-003.glb',
  ...
  },
  {
    ...
    name: 'Cat Eye',
    brand: 'GlamVision',
    modelPath: '/models/raw/glasses-004.glb',
  ...
  // Đã thêm kính thứ 5 để đủ số lượng yêu cầu
  {
    ...
    brand: 'RayStyle',
    modelPath: '/models/raw/glasses-005.glb',
